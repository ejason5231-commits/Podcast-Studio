...
// FIX: Corrected typo from FuseState to useState and fixed import syntax.
    ...
    return (
        <div className="flex flex-col items-center">
            <div className="w-full max-w-4xl space-y-8">
                ...
                <div className="space-y-4 p-4 bg-gray-50 dark:bg-gray-900/50 rounded-lg border border-gray-300 dark:border-gray-700">
                    <h3 className="text-lg font-semibold text-cyan-600 dark:text-cyan-400">Step 1: Define Topic & Speakers</h3>
                     <div className="flex flex-col items-center space-y-4">
                        <div className="w-full">
                            <label htmlFor="topic" className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Podcast Topic</label>
                            <input
                                id="topic"
                                type="text"
                                value={topic}
                        ...
                        <div className="w-full flex flex-col sm:flex-row gap-4">
                            <div className="w-full sm:w-1/2">
                                <label htmlFor="duration" className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Podcast Duration</label>
                                <select
                                    id="duration"
                                    value={duration}
                                    onChange={(e) => setDuration(e.target.value)}
                                    className="w-full p-2 bg-gray-200 dark:bg-gray-800 border border-gray-300 dark:border-gray-600 rounded-md focus:ring-2 focus:ring-cyan-500 appearance-none"
                                    style={{ 
                             ...
                             <div className="w-full sm:w-1/2">
                                <label htmlFor="proficiency" className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Proficiency Level</label>
                                <select
                                    id="proficiency"
                        ...
                        <div className="w-full">
                            <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Number of Speakers</label>
                            <div className="flex w-full rounded-md shadow-sm" role="group">
                                <button
                                    type="button"
                                    onClick={() => setSpeakerMode('one')}
                                    className={`w-1/2 px-4 py-2 text-sm font-medium border border-gray-300 dark:border-gray-600 rounded-l-lg transition-colors ${speakerMode === 'one' ? 'bg-cyan-600 text-white ring-2 ring-cyan-500' : 'bg-white text-gray-800 hover:bg-gray-200 dark:bg-gray-700 dark:text-gray-300 dark:hover:bg-gray-600'}`}
                                >
                                    One Speaker
                                </button>
                                <button
                                    ...
                                    className={`w-1/2 px-4 py-2 text-sm font-medium border-t border-b border-r border-gray-300 dark:border-gray-600 rounded-r-lg transition-colors ${speakerMode === 'two' ? 'bg-cyan-600 text-white ring-2 ring-cyan-500' : 'bg-white text-gray-800 hover:bg-gray-200 dark:bg-gray-700 dark:text-gray-300 dark:hover:bg-gray-600'}`}
                                >
                                    Two Speakers
                                </button>
                            </div>
                ...
                <div className="space-y-4 p-4 bg-gray-50 dark:bg-gray-900/50 rounded-lg border border-gray-300 dark:border-gray-700">
                    <div className="flex flex-wrap justify-between items-center gap-2 mb-2">
                        <h3 className="text-lg font-semibold text-cyan-600 dark:text-cyan-400">Step 2: Generate & Edit Script</h3>
                        <div className="flex items-center gap-2">
                            <button
                                onClick={handleImportScriptClick}
                                className="inline-flex items-center justify-center gap-2 px-3 py-2 border border-gray-300 dark:border-gray-600 text-sm font-medium rounded-md shadow-sm text-gray-800 dark:text-gray-300 bg-gray-200 dark:bg-gray-700 hover:bg-gray-300 dark:hover:bg-gray-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-100 dark:focus:ring-offset-gray-800 focus:ring-cyan-500 transition-colors"
                            >
                            ...
                            <button
                                ...
                                className="inline-flex items-center justify-center gap-2 px-3 py-2 border border-gray-300 dark:border-gray-600 text-sm font-medium rounded-md shadow-sm text-gray-800 dark:text-gray-300 bg-gray-200 dark:bg-gray-700 hover:bg-gray-300 dark:hover:bg-gray-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-100 dark:focus:ring-offset-gray-800 focus:ring-cyan-500 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
                            >
                    ...
                    <button
                        ...
                        className="relative w-full flex items-center justify-center px-6 py-3 border border-transparent text-base font-medium rounded-md shadow-sm text-white bg-cyan-600 hover:bg-cyan-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-100 dark:focus:ring-offset-gray-800 focus:ring-cyan-500 disabled:bg-gray-400 dark:disabled:bg-gray-500 disabled:cursor-not-allowed"
                    >
                        {isLoadingScript ? (
                    ...
                    <textarea
                        ...
                        rows={10}
                        className="w-full p-4 bg-gray-200 dark:bg-gray-800 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-cyan-500 transition-colors placeholder:text-gray-500 dark:placeholder:text-gray-400"
                ...
                {/* Step 3: Generate Audio */}
                 <div className="space-y-4 p-4 bg-gray-50 dark:bg-gray-900/50 rounded-lg border border-gray-300 dark:border-gray-700">
                    <h3 className="text-lg font-semibold text-cyan-600 dark:text-cyan-400">Step 3: Generate Audio</h3>
                    <button
                        onClick={handleGeneratePodcast}
                        disabled={isLoadingAudio || isLoadingScript || !script}
                        className="relative w-full flex items-center justify-center px-6 py-3 border border-transparent text-base font-medium rounded-md shadow-sm text-white bg-teal-600 hover:bg-teal-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-100 dark:focus:ring-offset-gray-800 focus:ring-teal-500 disabled:bg-gray-400 dark:disabled:bg-gray-500 disabled:cursor-not-allowed"
                    >
                        {isLoadingAudio ? (
                    ...
                    {error && <p className="text-red-600 dark:text-red-400 text-center pt-2">{error}</p>}
                    {audioUrl && (
                        <>
                            {isSaved ? 
                ...
                <div className="fixed inset-0 bg-black bg-opacity-60 flex items-center justify-center z-50 backdrop-blur-sm">
                    <div className="bg-gray-800 rounded-lg shadow-xl p-6 w-full max-w-sm text-center border border-gray-700">
                        <div className="flex justify-center mb-4">
                            <PlayCircleIcon className="w-12 h-12 text-cyan-400" />
                        </div>
                        <h3 className="text-xl font-bold text-white mb-2">Watch Ads to Generate</h3>
                        <p className="text-gray-400 mb-6">Confirm to proceed with generation.</p>
                        <div className="flex flex-col gap-2">
                            <button
                                onClick={handleConfirmGeneration}
                                className="w-full flex items-center justify-center px-4 py-3 border border-transparent text-base font-medium rounded-md shadow-sm text-white bg-cyan-600 hover:bg-cyan-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-800 focus:ring-cyan-500"
                            >
                                Generate
                            </button>
                            <button
                                onClick={() => setIsModalOpen(false)}
                                className="w-full flex items-center justify-center px-4 py-2 text-sm font-medium rounded-md text-gray-300 hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-800 focus:ring-gray-600"
                            >
                                Cancel
                            </button>
                        </div>
